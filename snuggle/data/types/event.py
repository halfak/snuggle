...
class ServerStarted(Event):
	...
	def __init__(self, server, id=None, system_time=None):
		Event.__init__(self, id=id, system_time=system_time)
...
class UserCategorized(Event):
	...
	def __init__(self, user, categorization, snuggler=None, id=None, system_time=None):
		Event.__init__(self, id=id, system_time=system_time)
		self.user           = User.deserialize(user)
		self.categorization = Categorization.deserialize(categorization)
		self.snuggler       = self.categorization.snuggler
